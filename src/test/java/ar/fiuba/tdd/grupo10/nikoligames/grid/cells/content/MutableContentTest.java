...
public class MutableContentTest {
    ...
    public void setValue() throws Exception {
        MutableContent<Integer> content = new MutableContent<>(new Number("2"),"value1");
        content.setValue(1);
    ...
    public void getValue() throws Exception {
        MutableContent<Integer> content = new MutableContent<>(new Number("2"),"value2");
        int value = content.getValue();
    ...
    public void isValueEditable() throws Exception {
        MutableContent<Integer> content = new MutableContent<>(new Number("1"),"value1");
    ...
    public void isEmpty() throws Exception {
        MutableContent<Integer> content = new MutableContent<>(new Number(null),"value1");
        assertTrue(content.isEmpty());
        content.setValue(2);
        assertFalse(content.isEmpty());
    }
    ...
    public void equals() throws Exception {
        MutableContent<Integer> content1 = new MutableContent<>(new Number("1"),"value1");
        MutableContent<Integer> content2 = new MutableContent<>(new Number("1"),"value1");
        MutableContent<Integer> content3 = new MutableContent<>(new Number("1"),"value2");
        MutableContent<Integer> content4 = new MutableContent<>(new Number("2"),"value1");
