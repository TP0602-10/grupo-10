...
/**
 * Created by xx on 27/10/16.
 */
public class CheckTopBorderOperationTests {
    ...
    private void createRule(List<Cell> cells) {
        ...
        GridRuleOperation<Boolean> operation = new CheckTopBorderOperation(tag);
    ...
    public void ruleVerifiesBordersCorrectlySet() {
        ...
        Line theLine = new HorizontalLine();
